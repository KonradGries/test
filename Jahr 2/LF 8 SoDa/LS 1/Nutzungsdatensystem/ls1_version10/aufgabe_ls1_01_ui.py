...
from aufgabe_ls1_01_stammdaten import nds_stammdaten
...
from aufgabe_ls1_01_stammdaten import nds_rechnerkategorien
...
class nds_ui:
    ...
    def auswahl_menue(self):
        ...
        print("   (18) Rechnerkategorie importieren")
        print("   (19) Rechnerkategorie löschen")
